...
const Footer = () => {
  return (
    <footer className="flex w-full flex-col items-center gap-8 bg-footerCyan px-5 py-12">
      <svg
        className="fill-darkDesaturatedCyan"
      ...
      <ul className="flex w-full justify-evenly font-barlow text-darkModerateCyan md:w-1/4">
        <li>
          <a className="transition ease-in-out hover:text-white" href="/">
            About
          </a>
        </li>
        <li>
      ...
      <ul className="flex gap-6 md:mt-14">
        <li>
          <a href="/">
            <svg
              className="group"
            ...
            >
              <path
                className="transition ease-in-out group-hover:fill-white"
                fill="#2C7566"
